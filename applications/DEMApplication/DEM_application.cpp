...
KRATOS_CREATE_VARIABLE(PolyhedronInformation, POLYHEDRON_INFORMATION)
...
KRATOS_CREATE_VARIABLE(int,    POLYHEDRON_SHAPE_INDEX)
...
KRATOS_CREATE_VARIABLE(double, CONTACT_K_N)
KRATOS_CREATE_VARIABLE(double, CONTACT_K_T)
...
KRATOS_CREATE_VARIABLE(Matrix, POLYHEDRON_MOMENT_OF_INERTIA)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(INITIAL_ROTATION_VECTOR)
// *************** Continuum only END ***************
...
KratosDEMApplication::KratosDEMApplication() : KratosApplication("DEMApplication"),
    ...
    mPolyhedronParticle3D(0, Element::GeometryType::Pointer(new Sphere3D1<Node >(Element::GeometryType::PointsArrayType(1)))), //although it is not a real sphere
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(POLYHEDRON_INFORMATION)
    ...
    KRATOS_REGISTER_VARIABLE(POLYHEDRON_SHAPE_INDEX)
    ...
    KRATOS_REGISTER_VARIABLE(CONTACT_K_N)
    KRATOS_REGISTER_VARIABLE(CONTACT_K_T)
    ...
    KRATOS_REGISTER_VARIABLE(POLYHEDRON_MOMENT_OF_INERTIA)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(INITIAL_ROTATION_VECTOR)
    // *************** Continuum only END ***************
    ...
    KRATOS_REGISTER_ELEMENT("PolyhedronParticle3D", mPolyhedronParticle3D)
