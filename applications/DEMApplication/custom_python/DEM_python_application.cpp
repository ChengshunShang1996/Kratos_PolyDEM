...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_POLYHEDRON_DISCONTINUUM_CONSTITUTIVE_LAW_NAME )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEM_POLYHEDRON_DISCONTINUUM_CONSTITUTIVE_LAW_POINTER )
    ...
    //KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POLYHEDRON_INFORMATION)
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, INITIAL_ROTATION_VECTOR)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POLYHEDRON_SHAPE_INDEX)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POLYHEDRON_MOMENT_OF_INERTIA)
    // *************** Continuum only END ***************
