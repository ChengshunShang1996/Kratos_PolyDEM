...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, std::string, DEM_POLYHEDRON_DISCONTINUUM_CONSTITUTIVE_LAW_NAME)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, int,    POLYHEDRON_SHAPE_INDEX)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, CONTACT_K_N)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, CONTACT_K_T)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, Matrix, POLYHEDRON_MOMENT_OF_INERTIA)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, INITIAL_ROTATION_VECTOR)
  // *************** Continuum only END ***************
