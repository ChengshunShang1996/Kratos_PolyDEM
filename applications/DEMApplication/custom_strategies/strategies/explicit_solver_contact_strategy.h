...
namespace Kratos {
    ...
    public:
        ...
        VectorDistanceType& GetResultsDistancesPoly() { return (mResultsDistancesPoly);}
        RadiusArrayType& GetArrayOfAmplifiedRadiiPoly() { return (mArrayOfAmplifiedRadiiPoly);}
    ...
    protected:
        ...
        bool mRigidBodyMotionForPolyWall = false;
